...
@Visual(id = "FinalDatasetOutput", label = "FinalDatasetOutput", x = 816, y = 105, phase = 0)
object FinalDatasetOutput {

  @UsesDataset(id = "18", version = 1)
    ...
    fabric match {
      case "azdb" =>
        ...
        in.write
          ...
          .option("sep", ",")
          .mode("overwrite")
          .save("dbfs:/Users/prophecy/eng/FinalDatasetOutput.csv")
